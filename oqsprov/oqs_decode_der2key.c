...
MAKE_DECODER(, "p256_OV_Ip_pkc_skc", p256_OV_Ip_pkc_skc, oqsx,
             SubjectPublicKeyInfo);
MAKE_DECODER(, "snova5o", snova5o, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova5o", snova5o, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p256_snova5o", p256_snova5o, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p256_snova5o", p256_snova5o, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova5oa", snova5oa, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova5oa", snova5oa, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p256_snova5oa", p256_snova5oa, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p256_snova5oa", p256_snova5oa, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova5", snova5, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova5", snova5, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p256_snova5", p256_snova5, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p256_snova5", p256_snova5, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova5a", snova5a, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova5a", snova5a, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p256_snova5a", p256_snova5a, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p256_snova5a", p256_snova5a, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova7", snova7, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova7", snova7, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p384_snova7", p384_snova7, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p384_snova7", p384_snova7, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova9", snova9, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova9", snova9, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p521_snova9", p521_snova9, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p521_snova9", p521_snova9, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova17", snova17, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova17", snova17, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p521_snova17", p521_snova17, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p521_snova17", p521_snova17, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova16", snova16, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova16", snova16, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p521_snova16", p521_snova16, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p521_snova16", p521_snova16, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "snova4", snova4, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "snova4", snova4, oqsx, SubjectPublicKeyInfo);
MAKE_DECODER(, "p256_snova4", p256_snova4, oqsx, PrivateKeyInfo);
MAKE_DECODER(, "p256_snova4", p256_snova4, oqsx, SubjectPublicKeyInfo);
